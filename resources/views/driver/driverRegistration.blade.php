...
<body class="bg-gradient-primary">
  ...
  <div class="container">
    ...
    <div style = "top: 50px" class="card o-hidden border-0 shadow-lg my-5">
      <div class="card-body p-0">
        ...
        <div class="row">
          ...
          <div class="col-lg-7">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">Create a Driver Account!</h1>
              </div>
              <form class="user" method="POST" action="{{ route('register') }}">
                        @csrf
                <div class="form-group row">
                  <div class="col-sm-12 mb-3 mb-sm-0">
                  <input hidden type="text" name="driver" value="1">
          ...
          <div class="col-lg-5 d-none d-lg-block bg-register-doctor"></div>
        </div>
      </div>
    </div>
